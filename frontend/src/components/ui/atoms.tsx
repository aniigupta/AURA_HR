      ...
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-lg font-medium transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 disabled:opacity-50 disabled:pointer-events-none cursor-pointer select-none active:scale-[0.98]",
          {
            ...
            "bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-semibold": variant === "soft",
            ...
            "h-9 sm:h-9.5 px-4 text-xs font-semibold": size === "md",
            "h-10 sm:h-11 px-5 sm:px-6 text-xs sm:text-sm font-semibold": size === "lg",
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center px-2 py-0.5 rounded-full text-[10px] sm:text-[11px] font-semibold border transition-colors whitespace-nowrap",
        {
      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 text-xs font-medium transition-all duration-150 border-b-2 -mb-px whitespace-nowrap cursor-pointer",
              isActive
